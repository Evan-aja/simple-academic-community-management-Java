...
public class ManDosen extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (JOptionPane.showConfirmDialog( delete,"Apakah Anda Yakin?","Update data Dosen",
           JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
            try {
                data.updateDosen(dataTmp.get(0),dataTmp.get(1),dataTmp.get(2),dataTmp.get(3),jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText());
            } catch (Exception ex) {
                Logger.getLogger(ManDosen.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        else return;
        this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
        JFrame delete = new JFrame();
        if (JOptionPane.showConfirmDialog( delete,"Apakah Anda Yakin?","Hapus Dosen",
           JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
            try {
                data.hapusDosen(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText());
            } catch (Exception ex) {
                Logger.getLogger(ManDosen.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
